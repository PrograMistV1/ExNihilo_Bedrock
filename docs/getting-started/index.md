...
(see [Sieve](../blocks/sieve.md) for details)
...
- a [composter](https://minecraft.fandom.com/wiki/Composter)
...
For melting, the crucible uses heat from torches, campfires, fire, lava, and other heat sources. See
[Crucible](../blocks/crucible.md) for details.
